...
#define UILABEL_CHARACTERSPACING   1.0f   //字间距
#define UILABEL_LINESPACING        4.5f   //行间距
#define UILABEL_PARAGRAPHSPACING   15.0f  //文本段间距
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        // Initialization code
        //如果外部不设置就是用默认值
        self.characterSpacing = UILABEL_CHARACTERSPACING;
        self.linesSpacing = UILABEL_LINESPACING;
    }
    return self;
}
...
- (void) initAttributedString
{
    if(attributedString==nil){
        ...
        //设置文本段间距
        CGFloat paragraphSpacing = UILABEL_PARAGRAPHSPACING;
