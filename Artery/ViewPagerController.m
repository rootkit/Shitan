...
- (IBAction)handleTapGesture:(id)sender {
    ...
    CLog(@"%@",weakPageViewController.view);
...
- (void)reloadData {
    ...
    UIViewController *viewController = [self viewControllerAtIndex:_m_row];
...
- (UIViewController *)pageViewController:(UIPageViewController *)pageViewController viewControllerAfterViewController:(UIViewController *)viewController {
    ...
    if (_isRight)
    {
        if ([viewController isKindOfClass:[TipsDetailsViewController class]]) {
            _m_row++;
            return [self viewControllerAtIndex:_m_row];
        }
    }
...
- (void)pageViewController:(UIPageViewController *)pageViewController willTransitionToViewControllers:(NSArray *)pendingViewControllers {
    CLog(@"willTransitionToViewController: %lu", [self indexForViewController:[pendingViewControllers objectAtIndex:0]]);
}
