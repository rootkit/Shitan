...
#define kTabHeight 40.0
#define kTabOffset 56.0
#define kTabWidth MAINSCREEN.size.width/2
#define kTabLocation 0.0
...
- (NSNumber *)tabHeight {
    ...
    if (!_tabHeight) {
        ...
        if ([self.delegate respondsToSelector:@selector(viewPager:valueForOption:withDefault:)])
            value = [self.delegate viewPager:self valueForOption:ICViewPagerOptionTabHeight withDefault:value];
...
- (NSNumber *)tabOffset {
    ...
    if (!_tabOffset) {
        ...
        if ([self.delegate respondsToSelector:@selector(viewPager:valueForOption:withDefault:)])
            value = [self.delegate viewPager:self valueForOption:ICViewPagerOptionTabOffset withDefault:value];
...
- (NSNumber *)tabWidth {
    ...
    if (!_tabWidth) {
        ...
        if ([self.delegate respondsToSelector:@selector(viewPager:valueForOption:withDefault:)])
            value = [self.delegate viewPager:self valueForOption:ICViewPagerOptionTabWidth withDefault:value];
...
- (NSNumber *)tabLocation {
    ...
    if (!_tabLocation) {
        ...
        if ([self.delegate respondsToSelector:@selector(viewPager:valueForOption:withDefault:)])
            value = [self.delegate viewPager:self valueForOption:ICViewPagerOptionTabLocation withDefault:value];
...
- (NSNumber *)startFromSecondTab {
    ...
    if (!_startFromSecondTab) {
        ...
        if ([self.delegate respondsToSelector:@selector(viewPager:valueForOption:withDefault:)])
            value = [self.delegate viewPager:self valueForOption:ICViewPagerOptionStartFromSecondTab withDefault:value];
...
- (NSNumber *)centerCurrentTab {
    ...
    if (!_centerCurrentTab) {
        ...
        if ([self.delegate respondsToSelector:@selector(viewPager:valueForOption:withDefault:)])
            value = [self.delegate viewPager:self valueForOption:ICViewPagerOptionCenterCurrentTab withDefault:value];
...
- (NSNumber *)fixFormerTabsPositions {
    ...
    if (!_fixFormerTabsPositions) {
        ...
        if ([self.delegate respondsToSelector:@selector(viewPager:valueForOption:withDefault:)])
            value = [self.delegate viewPager:self valueForOption:ICViewPagerOptionFixFormerTabsPositions withDefault:value];
...
- (NSNumber *)fixLatterTabsPositions {
    ...
    if (!_fixLatterTabsPositions) {
        ...
        if ([self.delegate respondsToSelector:@selector(viewPager:valueForOption:withDefault:)])
            value = [self.delegate viewPager:self valueForOption:ICViewPagerOptionFixLatterTabsPositions withDefault:value];
...
- (void)setNeedsReloadOptions {
    ...
    self.tabWidth = [NSNumber numberWithFloat:[self.delegate viewPager:self valueForOption:ICViewPagerOptionTabWidth withDefault:kTabWidth]];
    self.tabOffset = [NSNumber numberWithFloat:[self.delegate viewPager:self valueForOption:ICViewPagerOptionTabOffset withDefault:kTabOffset]];
    self.centerCurrentTab = [NSNumber numberWithFloat:[self.delegate viewPager:self valueForOption:ICViewPagerOptionCenterCurrentTab withDefault:kCenterCurrentTab]];
    self.fixFormerTabsPositions = [NSNumber numberWithFloat:[self.delegate viewPager:self valueForOption:ICViewPagerOptionFixFormerTabsPositions withDefault:kFixFormerTabsPositions]];
    self.fixLatterTabsPositions = [NSNumber numberWithFloat:[self.delegate viewPager:self valueForOption:ICViewPagerOptionFixLatterTabsPositions withDefault:kFixLatterTabsPositions]];
...
- (CGFloat)valueForOption:(ICViewPagerOption)option {
    ...
    switch (option) {
        case ICViewPagerOptionTabHeight:
            return [[self tabHeight] floatValue];
        case ICViewPagerOptionTabOffset:
            return [[self tabOffset] floatValue];
        case ICViewPagerOptionTabWidth:
