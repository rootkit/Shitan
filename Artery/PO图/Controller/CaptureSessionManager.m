...
// */
//- (void)createQueue {
//	dispatch_queue_t sessionQueue = dispatch_queue_create("com.Artery.sessionQueue", DISPATCH_QUEUE_SERIAL);
...
//        
//        CLog(@"设备名字: %@", [device localizedName]);
//        
...
//    
//	CLog(@"about to request a capture from: %@", _stillImageOutput);
//    
...
//                                                          NULL);
//        if (exifAttachments) {
//            CLog(@"attachements: %@", exifAttachments);
//        } else {
//            CLog(@"no attachments");
//        }
//        
...
//        
//        CLog(@"originImage:%@", [NSValue valueWithCGSize:image.size]);
//        
//        // TODO:保存一张图片
//        [CMCommon saveImageToPhotoAlbum:image];
//        
...
//        
//        CLog(@"scaledImage:%@", [NSValue valueWithCGSize:scaledImage.size]);
//        
//        [CMCommon saveImageToPhotoAlbum:scaledImage];
//        
//        CGRect cropFrame = CGRectMake((scaledImage.size.width - size.width) / 2 , (scaledImage.size.height - size.height) / 2 + headHeight*2, size.width, size.height);
//        
//        
//        CLog(@"cropFrame:%@", [NSValue valueWithCGRect:cropFrame]);
//        
//        
//        //第二次裁剪
//        UIImage *croppedImage = [scaledImage croppedImage:cropFrame];
//        CLog(@"croppedImage:%@", [NSValue valueWithCGSize:croppedImage.size]);
//        
//        
//        croppedImage = [Units image:croppedImage rotation:UIImageOrientationRight];
//        
//        
////        [CMCommon saveImageToPhotoAlbum:croppedImage];
//        
...
//        }
//        [CMCommon drawALineWithFrame:frame andColor:[UIColor whiteColor] inLayer:_preview.layer];
//    }
//}
//
//
