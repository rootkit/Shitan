...
- (void)commonInit {
    ...
    self.textColor = MAIN_TEXT_COLOR;
    ...
    UIColor *commonLinkColor = MAIN_COLOR;
    
    //点击时候的背景色
    [mutableActiveLinkAttributes setValue:(__bridge id)[[UIColor colorWithWhite:0.831 alpha:1.000] CGColor] forKey:(NSString *)kTTTBackgroundFillColorAttributeName];
