...
@property (nonatomic, assign) BOOL badgeShowShadow;

@property (nonatomic, assign) BOOL isPointBadge;

@property (nonatomic, assign) CGFloat badgePointSize;
